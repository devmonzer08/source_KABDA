...
ZelzalDV_cmd = (
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝗸𝗲𝗯𝗱𝗮 - اوامر بوت استخراج الجلسات](t.me/H_K_Y_P) 𓆪\n\n"
    "⪼ بوت استخراج جلسات الخاص بسورس كبدا \n"
    "⪼(@Sessions_TNT_bot)n"
    "⪼برعاية المطور كبدا  \n" 
    "⪼ ⪼ برعاية المطور كبدا \n"
    "\n𓆩 [𐇮 ⊀ᏦᎬᏰᎠᎯ 𐇮](t.me/Y_T_R_0) 𓆪"
)
...
async def add_sudo_user(event):
    ...
    output += "**✾╎يتم الان اعـادة تشغيـل بـوت كبدا انتظـر 2-1 دقيقـه ▬▭ ...**"
...
async def _(event):  # sourcery no-metrics
    ...
    output = (
        result + "**✾╎يتم الان اعـادة تشغيـل بـوت كبدا انتظـر 2-1 دقيقـه ▬▭ ...**\n"
    )
    if errors != "":
        output += "\n**- خطــأ :**\n" + errors
