...
ZED_TEXT = gvarstatus("CUSTOM_ALIVE_TEXT") or "•⎚• مـعلومـات المسـتخـدم مـن بـوت الراضي"
ZEDM = gvarstatus("CUSTOM_ALIVE_EMOJI") or "✦ "
ZEDF = gvarstatus("CUSTOM_ALIVE_FONT") or "⋆─┄─┄─┄─ 𝗸𝗲𝗯𝗱𝗮 ─┄─┄─┄─⋆"
zed_dev = (6655082279, 463636842)
zel_dev = (6655082279, 52581064)
zelzal = (6655082279, 6085292025)
