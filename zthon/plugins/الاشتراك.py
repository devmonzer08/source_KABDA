...
async def supc(event):  # Zed-Thon - ZelZal
    ...
    zed_dev = (1895219306, 5184436120, 0000000000, 0000000000)
    ...
    if gvarstatus ("sub_private"):
        try:
            ...
            if "error_code" in reqt:
                await zedub.tgbot.send_message(BOTLOG_CHATID, f"**- خطـأ غير معروف قم باعادة توجيه الرسالة ل@Y_T_R_0 لحل المشكلة\n{reqt}**")
