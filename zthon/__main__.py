...
LOGS = logging.getLogger("سورس كبدا")
...
async def startup_process():
    ...
    async def start_bot():
      try:
          List = ["U_R_B_I","H_K_Y_P","Monzer_rashq","TNT_CL","SOURSE_Al_Rady","Monzer_rashq","TNT_source","TNT_Ex_Z","TNT_source","TNT_CL","Help_Tnt"]
