    ...
    try:
        ...
        if BOTLOG:
            ...
            Config.ZEDUBLOGO = await zedub.tgbot.send_file(
                ...
                "https://telegra.ph/file/893f0262cb6af3460f8b0.jpg",
                
                caption="**•⎆┊تـم بـدء تشغـيل سـورس كبدا الخاص بك .. بنجاح 🧸♥️**",
                
                buttons=[(Button.url("𝗦َِ𝗼َِ𝗨َِ𝗿َِ𝗖َِ𝗲 َِ𝗸𝗲𝗯𝗱𝗮", "https://t.me/H_K_Y_P"),)],
...
zthon = {"@H_K_Y_P", "@T_I_P_O", "@TNT_CL", "@TNT_Ex_Z", "@Monzer_rashq", "@TNT_source"}
async def saves():
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        photozed = await zedub.upload_file(file="zedthon/malath/monzer.jpg")

        _, groupid = await create_supergroup(

            "كـروب السجـل كبدا", zedub, Config.TG_BOT_USERNAME, descript, photozed
    ...
    if PM_LOGGER_GROUP_ID != -100:
        ...
        photozed = await zedub.upload_file(file="zedthon/malath/monzer2.jpg")
